...
#### Filament
Speaking of **filament**, I bought and will continue to buy mine from [**MakerGeeks**](https://www.makergeeks.com/). They make it themselves in the **USA** to a very high standard, and have fantastic prices. I opted to get the [limited time grab bag](https://www.makergeeks.com/products/maker-filament-grab-bag-2kg-44lbs) for **$60**, which is a fscking awesome deal. I got two spools of ABS and two PLA, you don't get to choose color but it's not like I have any specific projects or anything, and you can paint it easily. I ended up with red and black PLA and yellow and green ABS.
...
{% include image.html name="printer-overview.JPG" caption="My current setup. You can see all the mods discussed above, as well as all the accessories." alt="3d printer overview" width="100%" %}
...
## Stay Tuned for [Part 2: Octoprint Configuration]({% post_url 2018-01-17-beagleprint-part-2 %})
